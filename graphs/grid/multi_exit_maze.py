...
Given the grid, maze, return a grid with the same dimensions. Each cell (r, c) should contain the minimum number of steps needed to go from position (r, c) in the maze to the closest exit. If (r, c) is a wall in the maze, return -1 at that position. It is guaranteed that every walkable cell can reach an exit.
